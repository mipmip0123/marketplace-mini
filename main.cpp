...
=======
    ...
    void menu_penjual(){
        ...
        //CEK KODE BERHASIL
            if (kode_kode == Codes[0].kode_penjual) {
>>>>>>> 5c45324 (saya menambahkan sorting mengurutkan harga produk dari paling rendah, menggunakan insertion sort)
                login_kode = true;
...
>>>>>>> 5c45324 (saya menambahkan sorting mengurutkan harga produk dari paling rendah, menggunakan insertion sort)
    ...
    cout << "data berhasil diurutkan berdasarkan harga terendah"<< endl;
    }
